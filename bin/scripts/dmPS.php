...
foreach ($runningProjects as $runningProject) {
    appendToLog(LG_MAIN, LG_INFO, "name : " . $runningProject->projectInfos->name, "environment : " . $runningProject->environment, "revision : " . $runningProject->revision, "ports : " . json_encode($runningProject->projectInfos->ports));
}